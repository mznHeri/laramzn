    ...
    <div class="card">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus-circle"></i> Add Config</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{url('dashboard/config/create')}}" method="post">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="form-group">
                        <label for="meta_key">Meta Key</label>
                        <input type="text" class="form-control" name="meta_key" id="meta_key" placeholder="Meta Key" required>
                    </div>

                    <div class="form-group">
                        <label for="meta_value">Meta Value</label>
                        <input type="text" class="form-control" name="meta_value" id="meta_value" placeholder="Meta Value" required>
                    </div>

                    <div class="form-group">
                        <label for="info">Info</label>
                        <textarea class="form-control" name="info" id="info" placeholder="Info"></textarea>
                    </div>
